...
if($_SERVER["REQUEST_METHOD"] === "POST"){
    ...
    $sql = sprintf("SELECT * FROM users 
            WHERE username = '%s'",
            $mysqli->real_escape_string($_POST["username_check"]));
        ...
        <div class="row">
            ...
            <div class="col-md-4" style="margin-top:40px">
                <form method="post" action="password_reset.php">
                    <table>
                        <tr>
                            <td><label for="username_check">enter username: </label></td>
                            <td><input type="text" name="username_check" placeholder="enter your username" ></td>
                        </tr>
                        <tr>
                            <td></td>
