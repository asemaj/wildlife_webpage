 ...
 $updatedinfo = false;
  if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    if($_POST['password_reset'] !== ''){
        $updated_password = password_hash($_POST['password_reset'], PASSWORD_DEFAULT);
    }
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <form method="post" action="reset.php">
                    <table>
                        <tr>
                            <td><label for="password_reset">New password: </label></td>
                            <td><input type="password" name="password_reset" placeholder="enter a new password"></td>
                        </tr>
                        <tr>
                            <td></td>
